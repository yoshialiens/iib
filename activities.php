...
<meta property="og:title" content="サプライズマーケティングとは？">
...
<meta name="description" content="日本一のサプライズマーケティング会社、株式会社いないいないばぁのサプライズマーケティングとは？のページです。サプマケと契約までの流れを紹介しています。">
...
<div class="h-sec">
<h1>サプライズマーケティングとは？ - 株式会社いないいないばぁ</h1>
<?php @include 'header-nav.php'; ?>
</div><!-- /h-sec -->
<ul class="h-sns">
<li class="snsBlock"><a href="https://www.facebook.com/inai2bar" target="_blank"><span class="icon-">&#xea8d;</span></a></li>
<li class="snsBlock"><a href="http://twitter.com/share?text=私たちが提供しているもの|株式会社いないいいないばぁ &amp;url=http://www.i-i-b.jp/activities.php" target="_blank"><span class="icon-">&#xea92;</span></a></li>
<li class="snsBlock"><a href="http://b.hatena.ne.jp/append?http://www.i-i-b.jp/activities.php" target="_blank"><span class="icon-">&#xeaba;</span></a></li>
</ul><!-- /h-sns -->
</div><!-- /PC MENU -->
...
<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb" itemprop="child"><a href="/activities.php" itemprop="url"><span itemprop="title">サプライズマーケティングとは？</span></a></li>
</ul>
</div><!-- /パンくず -->
...
<div class="Block Top">
<div class="Cont">
<h2>サプライズマーケティングとは？</h2>
<p class="catch">ABOUT SAPUMAKE</p>
</div><!-- /Cont -->
</div><!-- Block -->
...
<p><img src="common/img/activities/about01.jpg" alt="サプライズで企業を変えます。" width="800" height="800"></p>
</div>
<div class="firstLeft">
...
<p><img src="common/img/activities/ex01.jpg" alt="ディズニーの事例" width="400" height="400"></p>
</div>
...
<p><img src="common/img/activities/ex02.jpg" alt="某高級車ディーラーの事例" width="400" height="400"></p>
</div>
...
<div class="thirdBlock">
<div class="thirdImg f-r">
<p><img src="common/img/activities/ex03.jpg" alt="靴の通販小売会社の事例" width="400" height="400"></p>
</div>
<div class="thirdTxt f-l">
<h4>靴の通販小売会社の事例：</h4>
...
<p class="stepTxt">お申し込みフォームよりご用件をお問い合わせください。<br class="pcView">どのようなビジネスをしているのか、<br class="tabNoView">何のためにビジネスをやっているか<br class="tabNoView">などを教えてください。</p>
</li>
<li>
<p class="stepNumber">ステップ<span>2</span></p>
<p class="stepTitle">初回ヒヤリング</p>
<p class="stepTxt">弊社オフィスにて１度お話させて<br class="tabNoView">いただき、イメージの共有やどのような<br class="tabNoView">課題を解消したいかをお伺いします。 <br class="pcView">また、どのようなサプライズをご提案<br class="tabNoView">するかの具体例もご紹介します。<br>
<span>※ここまで無料となります。</span></p>
</li>
<li>
<p class="stepNumber">ステップ<span>3</span></p>
<p class="stepTitle">お申し込み</p>
<p class="stepTxt">ご納得していただいた場合は、お申し込みしていただきます。<br class="tabNoView">なお、契約前にこちらで１度検討させていただきます。<br>
...
<p class="stepTxt">検討させていただいたのち、契約書を<br class="tabNoView">交わします。期間は基本3ヶ月〜です。<br>
...
<p class="stepTxt">ヒアリングを元に、サプライズ企画案を<br class="tabNoView">３つ以上ご提案します。<br class="tabNoView">その内容を元に、実践するサプライズを煮詰めていきます。<br>
<span>※費用や必要に応じて、WEB制作やライティング作成などを含めた企画も行うことが可能です。</span></p>
</li>
<li>
<p class="stepNumber">ステップ<span>6</span></p>
<p class="stepTitle">サプライズの実践</p>
<p class="stepTxt">企画したサプライズを落とし込みます。<br class="pcView">進捗状況を確認するため、定期的に<br class="tabNoView">打ち合わせを進めます。この期間は<br class="tabNoView">お互いに全力で臨んでいきましょう。<br class="pcView">
契約終了後、残りの全体費用の50%を<br class="tabNoView">お振込いただきます。<br>
