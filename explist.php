<?php 
	...
	//体験談一覧の取得
	$exp_list = $experience_model->getReviewAll($p, $PAGE_SIZE);
	
	//全ページ数
	$page_count = ceil($experience_model->getReviewAllCount() / $PAGE_SIZE);
	...
	for($i=$p-5;$i<=$p+5;$i++)
	{
		...
		if($p==$i){
			...
			$navi_button_list[$i] = 'explist.php?p='.$i;
		}
	}
...
<meta property="og:url" content="http://rankroo.jp/explist.php" />
<meta property="og:site_name" content="Rankroo" />
<meta property="og:description" content="★★★★★★★★★★★★★" />
<link rel="canonical" href="http://rankroo.jp/explist.php" />
...
<a href="exp.php?archive_id=<?php echo $exp['archive_id']; ?>">
<li>
<div class="Thumb"><img src="<?php echo $exp['photo1']; ?>" width="204" height="156" alt="<?php echo htmlspecialchars($exp['title'],ENT_QUOTES,'UTF-8'); ?>のイメージ画像"></div>
<div class="Title"><?php echo htmlspecialchars($exp['title'],ENT_QUOTES,'UTF-8'); ?></div>
</li>
</a>
<?php } ?>
